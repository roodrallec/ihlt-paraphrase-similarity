...
* msr_paraphrase_train_gx.tst: a bit per line, being 1 when the pair of sentences in the corresponding line of msr_paraphrase_train_input.txt is a paraphrase, and being 0 otherwise.
